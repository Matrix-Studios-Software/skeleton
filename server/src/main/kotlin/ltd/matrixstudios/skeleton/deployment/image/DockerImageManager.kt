...
object DockerImageManager
{
    ...
    fun tagImage(id: String, repo: String, tag: String) = DeploymentService.dockerClient.tagImageCmd(id, repo, tag).exec()
    fun getImageData(id: String): Image?
    {
        return listImages().firstOrNull { it.id == "sha256:$id" }
    }
}